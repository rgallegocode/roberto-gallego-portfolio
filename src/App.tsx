...
const copy = {
  en: {
    ...
    kicker: 'Software engineering student · Platform & DevOps · Málaga, Spain',
    title: 'Versatility is the wild card\nthat completes any hand.',
    intro: 'I build reliable developer platforms, automate infrastructure and glue together CI/CD, cloud services and backend systems so teams can ship faster.',
    cta: 'Deal me in',
    contact: 'Let’s talk',
    aboutLabel: '01 / The player',
    aboutTitle: 'Curious by default.',
    aboutText: 'I am a Software Engineering student drawn to platform engineering and DevOps: the tooling, automation and infrastructure that turn code into reliable, scalable systems.',
  ...
  es: {
    ...
    kicker: 'Estudiante de ingeniería del software · Platform & DevOps · Málaga, España',
    title: 'La versatilidad es el comodín\nque completa cualquier jugada.',
    intro: 'Construyo plataformas de desarrollo fiables, automatizo infraestructura e integro CI/CD, servicios cloud y backend para que los equipos entreguen más rápido.',
    cta: 'Repartir cartas',
    contact: 'Hablemos',
    aboutLabel: '01 / El jugador',
    aboutTitle: 'Curiosidad por defecto.',
    aboutText: 'Soy estudiante de Ingeniería del Software con interés por platform engineering y DevOps: el tooling, la automatización y la infraestructura que convierten el código en sistemas fiables y escalables.',
  ...
  de: {
    ...
    kicker: 'Softwaretechnik-Student · Platform & DevOps · Málaga, Spanien',
    title: 'Vielseitigkeit ist der Joker,\nder jedes Blatt vervollständigt.',
    intro: 'Ich baue zuverlässige Entwicklerplattformen, automatisiere Infrastruktur und verbinde CI/CD, Cloud-Services und Backend-Systeme, damit Teams schneller liefern können.',
    cta: 'Karten austeilen',
    contact: 'Kontakt aufnehmen',
    aboutLabel: '01 / Der Spieler',
    aboutTitle: 'Neugier als Ausgangspunkt.',
    aboutText: 'Ich studiere Softwaretechnik und interessiere mich für Platform Engineering und DevOps: die Werkzeuge, Automatisierung und Infrastruktur, die Code in zuverlässige, skalierbare Systeme verwandeln.',
